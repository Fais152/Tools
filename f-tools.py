...
def gdown():
    print(blue + """
 ____       _             ____                      _                 _
|  _ \ _ __(_)_   _____  |  _ \  _____      ___ __ | | ___   __ _  __| |
| | | | '__| \ \ / / _ \ | | | |/ _ \ \ /\ / / '_ \| |/ _ \ / _` |/ _` |
| |_| | |  | |\ V /  __/ | |_| | (_) \ V  V /| | | | | (_) | (_| | (_| |
|____/|_|  |_| \_/ \___| |____/ \___/ \_/\_/ |_| |_|_|\___/ \__,_|\__,_|


Note : Downloaad File Google Drive
    """ + reset)
    print (green + "Contoh :  https://drive.google.com/u/0/uc?id=1kTVPXHE5p_lppeSEy6CbPg1V_4oOY6D4&export=download")
    site = input("Masukan URL : ")
    url = site
    hasil = "file.zip"
    gdown.download(url, hasil, quiet=False)
